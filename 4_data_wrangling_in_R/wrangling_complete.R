...
# In summary, the my_loess function returns a LOESS model object fitted to the specified 
# data using price_per as the dependent variable and date (converted to numeric) as the 
# independent variable, with the degree of smoothing controlled by the span parameter.
